let AstNode,Post,MeBlock,format;_030‍.x([["default",()=>Program]]);_030‍.w("../libs/astNode.js",[["default",["AstNode"],function(v){AstNode=v}]]);_030‍.w("./post",[["default",["Post"],function(v){Post=v}]]);_030‍.w("./meBlock.js",[["default",["MeBlock"],function(v){MeBlock=v}]]);_030‍.w("util",[["format",["format"],function(v){format=v}]]);
    ...
    constructor() {
        ...
        _030‍.g.console.log(AstNode.nodeTokenizer());
    }
    ...
    mockParse(val) {
        ...
        _030‍.g.console.log(this.blogItems.length);
    }
    ...
    parse() {
        ...
        _030‍.g.console.log("Blog type: " + this.blogType);
        _030‍.g.console.log("Blog name: " + this.blogName);

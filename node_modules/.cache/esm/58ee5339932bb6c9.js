let Tokenizer,AstNode,Post,MeBlock,format;_932‍.x([["default",()=>Program]]);_932‍.w("../libs/tokenizer",[["default",["Tokenizer","AstNode"],function(v){Tokenizer=AstNode=v}]]);_932‍.w("./post",[["default",["Post"],function(v){Post=v}]]);_932‍.w("./meBlock.js",[["default",["MeBlock"],function(v){MeBlock=v}]]);_932‍.w("util",[["format",["format"],function(v){format=v}]]);
    ...
    mockParse(val) {
        ...
        _932‍.g.console.log(this.blogItems.length);
    }
    ...
    parse() {
        ...
        _932‍.g.console.log("Blog type: " + this.blogType);
        _932‍.g.console.log("Blog name: " + this.blogName);

let Tokenizer;_342‍.x([["default",()=>AstNode]]);_342‍.w("./tokenizer.js",[["default",["Tokenizer"],function(v){Tokenizer=v}]]);console.log("importing tokenizer");
...
let _fs = require('fs');
    ...
    static nodeTokenizer() {
        _342‍.g.console.log("astnode.js nodeTokenizer: " + _tokenizer);

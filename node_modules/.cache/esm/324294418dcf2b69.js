_8dc‍.x([["default",()=>Tokenizer]]);/* Initializes the tokenizer, gets literals,
...
let _tokenizer = null;
    ...
    constructor(literals, filename) {
        ...
        try {
          console.log("tokenizer.js, attempting to find input file " + this.filename);
    ...
    spaceKillingTokenize(){
      ...
      console.log("tokenizer.js this.program: " + this.program);
